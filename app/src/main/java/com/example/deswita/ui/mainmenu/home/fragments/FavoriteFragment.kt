...
import com.example.deswita.databinding.FragmentFavoriteBinding
...
class FavoriteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFavoriteBinding.inflate(LayoutInflater.from(inflater.context),container,false)
    ...
    private fun initialRecyclerView() {
        ...
        adapter.setData(mainViewModel.destinationDummy3)
