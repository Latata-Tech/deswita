...
class AddEventActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnAddEvent?.setOnClickListener {
            ...
            when {
                ...
                imageUri == null -> Toast.makeText(this,"image required",Toast.LENGTH_SHORT).show()
                else -> {
                    val event = Event(121,imageUri.toString(),date,title,location,description)
    ...
    private fun sendNotification(event: Event) {
        ...
        val intent = Intent(this,EventActivity::class.java).apply {
            ...
            putExtra(EventActivity.EXTRA_EVENT,event)
        }
